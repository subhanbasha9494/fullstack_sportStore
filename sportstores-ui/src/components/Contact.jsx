...
const Contact = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await apiClient.post("/contacts", contactRequestDto);
            setResponseMessage(response.data); // backend returns string
    ...
    return (
        <div className="max-w-[1152px] min-h-[852px] mx-auto px-6 py-8 font-primary bg-normalbg dark:bg-darkbg">
            ...
            {/* Response Message */}
            {/* {responseMessage && (
                <p className="mt-6 text-center text-lg font-semibold text-green-600 dark:text-light">
                    {responseMessage}
                </p>
            )} */}
        </div>
